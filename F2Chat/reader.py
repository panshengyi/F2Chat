...
class Reader(DatasetReader):
    def __init__(self,
        ...
        self._processer = Processer(tokenizer=tokenizer,
                                    ...
                                    text_only=text_only,
                                    use_PTM=use_PTM)
        self._same_diff_ratio = same_diff_ratio or {"diff": {"intention": 6, "num_per_intention": 1}, "same": 2}  # sample ratio for positive pairs and negative pairs
        # weights for np.random.choice, to tackle the unbalanced dataset problem
        ...
        self._use_level1 = use_level1  # information types of level 1
        ...
        if "golden" in file_path:
            ...
            for _ in range(iter_num):
                for sample in all_data:
                    ...
                    same_num += same_per_sample  # positive pairs
                    diff_num += diff_per_sample  # negative pairs
